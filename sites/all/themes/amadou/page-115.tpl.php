...
?>		</div><!-- end header_login -->
    ...
    <?php if ($title) : print '<h1 class="pageTitle" style="margin-bottom: 0;">The Queen\'s Birthday Ball - 5th June 2010</h1>'; endif; ?>
	<?php if ($title) : print '<h2 class="title" style="margin: 0 0 0 1em; border: none;">' . $title . '</h2>'; endif; ?>
