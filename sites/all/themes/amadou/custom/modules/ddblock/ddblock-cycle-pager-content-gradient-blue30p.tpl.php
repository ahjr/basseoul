...
/*!
 * Dynamic display block module template: gradient-blue30p - pager template
 * Copyright (c) 2008 - 2009 P. Blaauw All rights reserved.
 * Version 1.0 (14-APR-2009)
   ...
   <?php foreach ($pager_items as $pager_item): ?>
    <div class="<?php print $pager ?>-item <?php print $pager ?>-item-<?php print $item_counter ?>">
     <div class="corners"> 
      ...
      <a href="#" title="click to navigate to topic" class="pager-link"><?php print $pager_item['text']; ?> </a>
      </div>
      <div class="tl"></div>
      <div class="tr"></div>
      <div class="bl"></div>
